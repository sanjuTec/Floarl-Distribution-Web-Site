                                ...
                                <div class="col-12 mb-3">
								 ...
								 <div class="col-12 mb-3">
                                    ...
                                    <select class="w-100"  name="district" required>
                                        ...
                                        <option value="ind">Colombo</option>
                                        <option value="aus">Galle</option>
                                        <option value="bra">Gampaha</option>
                                        <option value="cana">Hambanthota</option>
										<option value="cana">Jaffna</option>
										<option value="cana">Kalutara</option>
